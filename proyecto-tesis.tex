...
\Large
\begin{center}
\begin{tabular}{|rp{0.3\textwidth}|p{0.6\textwidth}|}\hline
     1.& \textbf{\mbox{Título del Proyecto}
                 \mbox{de Tesis}}        & \emph{GPU-accelerated
                                           particle-based
                                           fluid simulations
                                           in a dynamic programming language}. \\\hline
     2.& \textbf{Nombre del Alumno}      & Roberto Javier Bonvallet Carrasco \\\hline
     3.& \textbf{Número de Teléfono}     & no tiene \\\hline
     4.& \textbf{E-mail}                 & \texttt{rbonvall@inf.utfsm.cl} \\\hline
     5.& \textbf{\mbox{Fecha de ingreso}
                 \mbox{al programa}}     & Primer semestre de 2006 \\\hline
     6.& \textbf{Pregrado}               & \mbox{Licenciatura en Ingeniería Informática},
                                           \mbox{UTFSM, 2006} \\\hline
     7.& \textbf{Profesor guía de tesis} & Luis Salinas Carrasco \\\hline
     8.& \textbf{\mbox{Fecha presentación}
                 \mbox{tema de tesis}}   & Martes 9 de diciembre de 2008 \\\hline
     9.& \textbf{\mbox{Fecha aprobación}
                 \mbox{tema de tesis}}   & \\\hline
    10.& \textbf{\mbox{Fecha tentativa}
                 \mbox{de término}}      & Junio de 2009 \\\hline
    11.& \textbf{\mbox{Comisión interna}
                 \mbox{de graduación}}   & profe$_1$,
                                           profe$_2$,
                                           profe$_3$.
         \\\hline
\end{tabular}
