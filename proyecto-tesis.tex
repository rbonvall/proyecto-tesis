...
\begin{tabular}{|%
    r <{.} @{ } %
    >{\bfseries\raggedright\hspace{0pt}} p{0.26\textwidth} |%
    >{\raggedright\hspace{0pt}}          p{0.5\textwidth} <{} |%
}\hline
   1 & Título del proyecto de tesis & \emph{GPU-accelerated particle-based fluid simulations in a dynamic programming language}. \tnhl
  ...
  10 & Fecha tentativa de término       & Junio de 2009 \tnhl
