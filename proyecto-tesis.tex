...
\begin{tabular}{|rp{0.3\textwidth}|p{0.6\textwidth}|}\hline
     1.& \textbf{Título del Proyecto de Tesis} &
         \emph{GPU-accelerated particle-based fluid simulations in a dynamic programming language}. \\\hline
     2.& \textbf{Nombre del Alumno} &
         Roberto Javier Bonvallet Carrasco \\\hline
     3.& \textbf{Número de Teléfono} &
         no tiene \\\hline
     4.& \textbf{E-mail} &
         \texttt{rbonvall@inf.utfsm.cl} \\\hline
     5.& \textbf{Fecha de ingreso al programa} &
         Primer semestre de 2006 \\\hline
     6.& \textbf{Pregrado} &
         Licenciatura en Ingeniería Informática, UTFSM, 2006 \\\hline
     7.& \textbf{Profesor guía de tesis} &
         Luis Salinas Carrasco \\\hline
     8.& \textbf{Fecha presentación tema de tesis} &
         Martes 9 de diciembre de 2008 \\\hline
     9.& \textbf{Fecha aprobación tema de tesis} &
         \\\hline
    10.& \textbf{Fecha tentativa de término} &
         Junio de 2009 \\\hline
    11.& \textbf{Comisión interna de graduación} & 
         Profe$_1$ \\
      && Profe$_2$ \\
      && Profe$_3$ \\\hline
\end{tabular}
...
\begin{enumerate}
    \item \textbf{Título del Proyecto de Tesis:}
        \emph{GPU-accelerated particle-based fluid simulations in a dynamic
