...
de componentes para hacer simulaciones de dinámica de fluídos mediante métodos
...
La metodología del proyecto se llevará a cabo en las siguientes etapas:
\begin{enumerate}
    ...
    \item \textbf{Prototipo de integración de GPU con el intérprete del lenguaje:}
        ...
        hardware con el intérprete existentes en la literatura y en el entorno
...
\begin{tabular}{|%
    ...
    Definición de experimentos y pruebas & 1 de mayo de 2009 \tnhl
