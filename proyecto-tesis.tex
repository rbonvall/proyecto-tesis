...
%   8.& Fecha presentación tema de tesis & Martes 9 de diciembre de 2008\tnhl
  ...
  10.& Fecha tentativa de término       & Agosto de 2009\tnhl
...
nivel es un área de investigación activa.
...
de modo que incluso algoritmos de propósito general
debían ser implementados en función de directivas gráficas~\cite[\S2.2]{brookgpu},
como shaders, fragmentos y texturas.
...
En particular, las aplicaciones con alta intensidad aritmética (tasa de
operaciones por ancho de banda de memoria) son las que mejor aprovechan las
arquitecturas gráficas~\cite[\S2.1]{brookgpu}.
...
\begin{thebibliography}{99}
    ...
    \bibitem{pycuda-cse}
    Andreas Klöckner.
    \reftitle{PyCuda and PyUblas.}
    2009 SIAM Conference on Computational Science and Engineering.
    Diapositivas en \url{https://cirl.berkeley.edu/fperez/py4science/2009_siam_cse/pycuda-siam.pdf}
...
\begin{tabular}{|%
    ...
    Estado del arte           & 1 de mayo de 2009 \tnhl
